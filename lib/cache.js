...
class CacheManager {
  ...
  clearPattern(pattern) {
    ...
    console.log(
      `🧹 Cache: Cleared ${keysToDelete.length} entries matching pattern "${pattern}"`,
    );
  }
...
export class SessionCache {
  ...
  clearPattern(pattern) {
    ...
    console.log(
      `🧹 SessionCache: Cleared ${memoryKeysToDelete.length + keysToRemove.length} entries matching pattern "${pattern}"`,
    );
  }
