...
export default function Cart() {
  ...
  const formatPrice = (price) => {
    // Handle undefined, null, or non-numeric prices
    const numericPrice =
              ...
              {items.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-6">
                    Start shopping and add some fresh products to your cart!
                  </p>
                  <Link
                    href="/products"
                    className="inline-flex items-center px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-lg font-medium transition transform hover:scale-105"
                  >
                    ...
                    >
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <button
                          ...
                          className="text-red-500 hover:text-red-700 p-2 hover:bg-red-50 dark:hover:bg-red-900 rounded transition"
                        >
